...
aco = PSO(problem, swarm_size=50, iterations=300, seed=42, executer_type='gpu', inertia_weight=0.9, cognitive_weight=0.4, social_weight=0.7)
...
pso = PSO(problem2, swarm_size=1024, iterations=100, seed=42, executer_type='gpu', inertia_weight=0.9, cognitive_weight=0.5, social_weight=0.8)
print("Starting PSO TSP...")
